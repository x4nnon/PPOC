...
WANDB_PROJECT_NAME="e2e_OC_Climber_warmup"
...
WANDB_PROJECT_NAME="PPO_Climber_comparison_A"
...
for x in "${X_VALUES[@]}"; do
    python3 methods/OC_PPO.py --warmup=0 --env_id="$ENV_ID" --total_timesteps=5000000 --seed="$x"\
     --wandb_project_name="$WANDB_PROJECT_NAME" --proc_start=1 --proc_num_levels=32 --num_envs=32 --eval_batch_size=32
