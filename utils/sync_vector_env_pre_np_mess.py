...
class SyncVectorEnv(VectorEnv):
    ...
    def fracos_step_async(self, action, next_obs, agent, total_rewards=0, top_level=False):
        ...
        for i, (env, action, obs) in enumerate(zip(self.envs, self._actions, next_obs)):            
            (
                observation,
                self._rewards[i],
                _,
            ...
            ) = env.fracos_step(action, obs, agent, top_level=top_level)
